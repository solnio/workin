<?php
    ...
    $tabs = array(
        array(
            'id'      => 'redux-help-tab-1',
            'title'   => __( 'Theme Information 1', 'workin' ),
            'content' => __( '<p>This is the tab content, HTML is allowed.</p>', 'workin' )
        ),
        array(
            'id'      => 'redux-help-tab-2',
            'title'   => __( 'Theme Information 2', 'workin' ),
            'content' => __( '<p>This is the tab content, HTML is allowed.</p>', 'workin' )
        )
    );
    ...
    $content = __( '<p>This is the sidebar content, HTML is allowed.</p>', 'workin' );
